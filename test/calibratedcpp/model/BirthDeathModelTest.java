...
class BirthDeathModelTest {
    ...
    void calculateLogDensity() {
        assertEquals(-8.390925, birthDeathModelSuperCrit.calculateLogDensity(10), 1e-4, "Log density incorrect.");
        assertEquals(-3.443752, birthDeathModelSuperCrit.calculateLogDensity(5), 1e-4, "Log density incorrect.");
        assertEquals(-1.200227, birthDeathModelSuperCrit.calculateLogDensity(1), 1e-4, "Log density incorrect.");

        assertEquals(-12.4932, birthDeathModelSubCrit.calculateLogDensity(10), 1e-4, "Log density incorrect.");
        assertEquals(-7.49198, birthDeathModelSubCrit.calculateLogDensity(5), 1e-4, "Log density incorrect.");
        assertEquals(-3.425174, birthDeathModelSubCrit.calculateLogDensity(1), 1e-4, "Log density incorrect.");

        assertEquals(-4.795791, birthDeathModelCrit.calculateLogDensity(10), 1e-4, "Log density incorrect.");
        assertEquals(-3.583519, birthDeathModelCrit.calculateLogDensity(5), 1e-4, "Log density incorrect.");
        assertEquals(-1.386294, birthDeathModelCrit.calculateLogDensity(1), 1e-4, "Log density incorrect.");
    }
